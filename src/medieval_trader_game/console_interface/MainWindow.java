...
import medieval_trader_game.MTGame;
...
public class MainWindow {
    ...
    public MainWindow(){
        ...
        window.setSize(MaxValues.WINDOW_WIDTH,MaxValues.WINDOW_HEIGHT);

        window.setLayout( new BorderLayout() );
        window.getContentPane().getInsets().set( 10, 10, 10, 10 );

        console.setPreferredSize( new Dimension(MaxValues.WINDOW_WIDTH, 60) );
        generalInfoBox.setPreferredSize(  new Dimension(MaxValues.WINDOW_WIDTH, 20) );
        ...
        input.setPreferredSize( new Dimension(MaxValues.WINDOW_WIDTH, 20) );
